<div class="headerbar">
	<div class="clearfix">
	<h1 class="pull-left"><?php echo lang('concierge'); ?></h1>
		<?php
		if(count($concierge) == 0){
		?>
		<a class="btn btn-primary pull-right" href="<?php echo site_url('admin/captions/form/concierge'); ?>">
...
<table class="table table-bordered datatable data_table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a class="btn btn-primary edit btn-sm" href="<?php echo site_url('admin/captions/form/' . $q->id.'/concierge'); ?>">
					<i class="entypo-pencil"></i>
				</a>
				<a class="btn btn-danger btn-sm" href="<?php echo site_url('admin/captions/delete/' . $q->id.'/concierge'); ?>" onclick="return confirm('<?php echo lang('delete_record_warning'); ?>');" >
