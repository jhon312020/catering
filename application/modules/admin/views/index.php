...
<div class="row">
	...
	<div class="col-sm-3">	
		<div class="tile-stats tile-purple-dark" style="background-color:#BA9551;">
			<div class="num" data-start="0" data-end="<?php echo $total_orders; ?>" data-postfix="" data-duration="1400" data-delay="0">0</div>
			<a href="javascript:void(0);"><h3><?php echo lang('orders'); ?></h3></a>
		</div>
	</div>
</div>	
