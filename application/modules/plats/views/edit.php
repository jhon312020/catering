	...
	<div class="row" id="business">
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php echo form_dropdown(array('name'=>'OrdrePlat', 'class'=>'form-control', $disabled=>true), $internal_codes, array($this->mdl_plats->form_value('OrdrePlat'))); ?>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<?php echo form_upload(array('name'=>'image', 'class'=>'form-control file2 inline btn btn-primary', 'value'=>$this->mdl_plats->form_value('image'), $readonly=>true)); ?>
					<?php if($this->mdl_plats->form_value('image')) {  ?>
						<img src="<?php echo $path . $this->mdl_plats->form_value('image'); ?>" width="150">
						<?php } ?>
				</div>
			</div>
			<div class="form-group">
