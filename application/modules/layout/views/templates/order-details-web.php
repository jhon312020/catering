...
<div class="col-sm-12 fix-left-right mob-hide">
  ...
  <div id="order_total">
  <a style="float:left;" href="<?php echo site_url(PAGE_LANGUAGE.'/orders/'); ?>" class="btn btn-menu cus-button" role="button"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> VOLVER</a>
    <?php if (isset($discount) && $discount) { ?>
      <h3>Discount : <span>-<?php echo $discount['discount']; ?> &euro;</span><br/>
      Total : <span><?php echo $discount['total_price']; ?> &euro;</span></h3>
    <?php } else { ?>
