<html>
  ...
  <body style="font-family:Helvetica">
    <div style="width:100%;">
      <div class="logo" style="width:100%;background-color:#101010;text-align:right;">
        ...
        <tbody>
          <tr>
            <td style="vertical-align:top;">
              <b style="color: <?=$color1?>;">CLIENTE:</b><br/>
              <b><?=$user_name?>,</b><br/>
              <?=$businessInfo->name?><br/>
              <?php echo $client[0]['billing_data']; ?>
            </td>
            <td style="width:200px;">
              <table style="border-collapse:collapse;width:200px;text-align:left;float:right;">
                <tbody>
                <tr>
                  <td style="padding:2px;padding-bottom:15px;font-weight:bold;">
                  <b style="color: <?=$color1?>;">FACTURA Nº:</b><br/>
                  GC<?php echo date('Y').'_'.$reference_no; ?>
                  </td>
                </tr>
                <tr>
                  <td style="padding:2px;font-weight:bold;">
                  <b style="color: <?=$color1?>;">FECHA:</b><br/>
